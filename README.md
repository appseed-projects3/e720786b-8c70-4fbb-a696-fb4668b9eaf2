...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-09 16:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e720786b-8c70-4fbb-a696-fb4668b9eaf2.git
$ cd e720786b-8c70-4fbb-a696-fb4668b9eaf2
```
